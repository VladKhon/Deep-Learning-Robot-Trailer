...
# early_stopping_cb = keras.callbacks.EarlyStopping(min_delta=0.0001, patience=30, restore_best_weights=True)
...
model = keras.models.load_model("Models/ControlRNN_Dynamics_2.h5")
model.summary()
...
# model.save_weights('Models/ControlRNN_Dynamics_2_weights.h5')
